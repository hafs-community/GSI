...
!-------------------------------------------------------------------------------------------------------------------
      ...
      do i=1,20
         ...
         if(meto(i)/=0) then
            sattab(099,meto(i),1,1)=241; sattab(099,meto(i),1,2)=20 ! MSG TYPE 005-099 CIMSS AMV TROPICAL CYCLONE WINDS
         endif
         if(viir(i)/=0) then
            sattab(099,viir(i),1,1)=241; sattab(099,viir(i),1,2)=20 ! MSG TYPE 005-099 CIMSS AMV TROPICAL CYCLONE WINDS
         endif
      enddo
