...
! !USES:
  ...
  use hybrid_ensemble_parameters,only : l_hyb_ens,uv_hyb_ens,aniso_a_en,generate_ens,&
                         ...
                         readin_localization,write_ens_sprd,write_obs_sprd,eqspace_ensgrid,grid_ratio_ens,&
...
!
  namelist/hybrid_ensemble/l_hyb_ens,uv_hyb_ens,q_hyb_ens,aniso_a_en,generate_ens,n_ens,&
                ...
                grid_ratio_ens, &
                oz_univ_static,write_ens_sprd,write_obs_sprd,use_localization_grid,use_gfs_ens, &
