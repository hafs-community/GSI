...
!$$$
    ...
    if(l_hyb_ens) then
       ...
       deallocate(ps_bar)
       deallocate(en_perts)
       if (allocated(q_perts)) deallocate(q_perts)
       if (allocated(t_perts)) deallocate(t_perts)
       if (allocated(u_perts)) deallocate(u_perts)
       if (allocated(v_perts)) deallocate(v_perts)
